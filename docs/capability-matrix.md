...
- `[REDACTED_SOURCE_REPO_01]`
- `[REDACTED_SOURCE_REPO_02]`
- `[REDACTED_SOURCE_REPO_03]`
- `[REDACTED_SOURCE_REPO_04]`
- `[REDACTED_SOURCE_REPO_05]`
- `[REDACTED_SOURCE_REPO_06]`
- `[REDACTED_SOURCE_REPO_07]`
- `[REDACTED_SOURCE_REPO_08]`
- `[REDACTED_SOURCE_REPO_09]`

## Sprint Inputs Included

Sprint umbrellas and child tasks from `[REDACTED_SOURCE_REPO_06]`:
...
| --- | --- | --- | --- |
| Central `AGENTS.md` governance | [REDACTED_SOURCE_REPO_01], IE, Citykleta | High | Core |
...
| Secret hygiene + secret scan workflow | IE, [REDACTED_SOURCE_REPO_01] | Medium | Core |
...
| Dedicated agent definitions under `.github/agents` | [REDACTED_SOURCE_REPO_01], IE, WM | High | Core |
...
| Large enterprise SOP tree (company-wide playbooks) | [REDACTED_SOURCE_REPO_01], KE handbook | High but domain-specific | Optional |
