...
- `ie-agentic-dev-env` context ops docs/scripts and sprint task descriptions (`#13`-`#18`)
- `wm-odoo-enterprise-16` context catalog, sync pipeline, DB model extraction
- `flexsport-agentic-dev-env` lightweight context-ready/context-wip split
- `AI-Company` context-engine pilot and infrastructure context builder patterns
